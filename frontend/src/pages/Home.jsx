        ...
        <div className={s.innerContainer}>
            ...
            <div className={s.heroGrid}>
              <div>
                ...
                <h1 className={s.heroTitle}>
                  Manage students,books, and fines in one library
                </h1>
                <p className={s.heroText}>
                  This library management portal gives students a focused
                  borrowing dashboard and gives admins a practical worksapce for
                  manual circulation, user records and overdue tracing.{" "}
                </p>
              ...
              <div className="grid gap-4">
                <div className={s.infoCard}>
                  ...
                  <p className={s.infoCardTitle}>
                    Seperate student and admin dashboards built for daily
                    library operations
                  </p>
          ...
          <section className={s.featuresGrid}>
            {features.map(({ icon, title, text }) => {
              return <article key={title} className={s.featureCard}>
                <span className={s.featureIconWrapper}>
                  {createElement(icon, { size: 22 })}
                </span>
                <h2 className={s.featureTitle}>{title}</h2>
                <p className={s.featurText}>{text}</p>
              </article>;
            })}
          </section>
        </div>
