...
import { studentSemesters, studentYears } from "../../data/libraryData.js";
import {
  ArrowRight,
  CheckCircle,
  Eye,
...
const Signup = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!validateStepOne() || !form.otp.trim() || !validateStepThree) {
      setError("Please complete all the steps first.");
      return;
    }
    setLoading(true);
      ...
      <div className={s.mainCard}>
        <section className={s.formPanel}>
          <div className={s.formInner}>
            ...
            <p className={s.panelSubtitle}>
              Complete the student signup steps: account, OTP ad profile.
            </p>
              ...
              <div className={s.buttonGroup}>
                ...
                {step < 3 ? (
                  ...
                  <button
                    ...
                    disabled={loading}
                  >
                    {loading ? "Completing Prfile..." : "Complete Profile"}
                    {!loading && <ArrowRight size={15} />}
                  </button>
                )}
              </div>
        ...
        <section className={s.infoPanel}>
          ...
          <h2 className={s.infoTitle}>
            Create Student account, verify OTP, and finish the profile in three
            steps.
          </h2>
