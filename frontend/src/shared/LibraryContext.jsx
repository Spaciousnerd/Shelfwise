...
export const LibraryProvider = ({ children }) => {
  ...
  const fetchFineSettings = async () => {
    try {
      const response = await fetch(`${BASE_URL}/fine-settings`, {
        headers: getHeaders(),
      });
  ...
  const issueManualBooksToStudent = async ({
    ...
    try {
      console.log(studentDetails, manualBooks);
      const response = await fetch(`${BASE_URL}/issue-manual`, {
        method: "POST",
        headers: getHeaders(),
        body: JSON.stringify({
          studentDetails,
  ...
  const returnIssuedRecord = async ({ source, recordId, bookId = null }) => {
    ...
    try {
      const response = await fetch(`${BASE_URL}/issues/${recordId}/return`, {
        method: "PUT",
        headers: getHeaders(),
      });
  ...
  const applyFineToRecord = async ({
    ...
    try {
      const response = await fetch(`${BASE_URL}/issues/${recordId}/fine`, {
        method: "PUT",
        headers: getHeaders(),
  ...
  const clearFineForRecord = async ({ source, recordId, bookId = null }) => {
    ...
    try {
      const response = await fetch(
        `${BASE_URL}/issues/${recordId}/clear-fine`,
        {
          method: "PUT",
          headers: getHeaders(),
        },
