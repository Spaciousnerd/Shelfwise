        ...
        <div className={s.sidebarHeader}>
          <div className="min-w-0 pr-3">
            <div className={s.logoWrapper}>
              {logoSrc ? (
                <img src={logoSrc} alt="" className={s.logoImage} />
              ) : (
                <BookCopy size={22} />
              )}
            </div>
            ...
            {badge && <span className={`${s.badgeBase} ${badgeStyles}`}></span>}
          </div>
          <button
            onClick={() => setOpen(false)}
            type="button"
            ...
            if (item.action) {
              return (
                <button
                  ...
                  type="button"
                  onClick={item.action}
                  className={`${s.footerButton} ${item.kind === "primary" ? s.footerButtonPrimary : s.footerButtonPrimary}`}
                >
