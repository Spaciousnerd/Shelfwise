        ...
        <div className={s.heroFlex}>
          <div>
            ...
            <p className={s.heroText}>
              Each card now uses clearer top summary, status badge, context
        ...
        <div className={s.sectionHeader}>
          <div>
            ...
            <p className={s.sectionSubtitle}>
              Medium sized cards now seperate the headline details from the
          ...
          {filteredIssuedBooks.length ? (
            filteredIssuedBooks.map((record) => (
              <UserBookCard
                key={record.id}
                record={record}
                borrowedName={currentUser?.name ?? "Studnet"}
              />
            ))
          ) : (
